...
RUN mkdir -p /var/log/supervisor \
    ...
    && touch /var/log/supervisor/worker-order-completion.log \
    && touch /var/log/supervisor/worker.log \
    && touch /var/log/supervisor/laravel-retry-pending-orders-worker.log \
    && chmod 777 /var/log/supervisor/supervisord.log \
    && chmod 777 /var/log/supervisor/apache2.log \
    && chmod 777 /var/log/supervisor/worker-order-completion.log \
    && chmod 777 /var/log/supervisor/worker.log \
    && chmod 777 /var/log/supervisor/laravel-retry-pending-orders-worker.log
